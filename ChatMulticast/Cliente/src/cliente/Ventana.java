...
public class Ventana implements ActionListener{
    ...
    public Ventana(int operacion){
        statusOp = operacion;
        salida = 0;
        Nombre = JOptionPane.showInputDialog("Welcome to Chat Muticast Room");
    ...
    private void inicializarComponentes(){
        panel = new JPanel();
        JLabel titulo = new JLabel("User chat: " + Nombre);
    ...
    private void setButtons(){
        ...
        newChat.setText("Private chat 1-1");
    ...
    private void newChat(String nombre){
        ...
        botonesEnviar.get(botonesEnviar.size() - 1).setText("Send");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(boton.getActionCommand().equals("Private chat 1-1")){
        ...
        }else if(boton.getActionCommand().equals("Send")){
            statusOp = 1;
        }
    }
}
